# Development Tips & Guides

This document contains various tips and guides for system setup, kernel development, virtualization, and other development tools.

---

## 1. OS Setup & Configuration
...
- Network static IP setting:
  ...
  netsh interface ip add dns name='Embedded LOM 1 Port 1' addr=10.0.0.64 index=2
...
1. Create a new DWORD value called **EnableLinkedConnections**, and set it to 1
2. Restart your PC and you are done.
